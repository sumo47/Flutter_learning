...
//TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
  ...
  void nextStory(int number) {
    if (number == 1 && (_storyNumber == 0 || _storyNumber == 1)) {
      _storyNumber = 2;
    } else if (number == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (_storyNumber == 2 && number == 1) {
      _storyNumber = 5;
    } else if (_storyNumber == 2 && number == 2) {
      _storyNumber = 4;
    } else if (_storyNumber == 1 && number == 2) {
      _storyNumber = 3;
    } else if (_storyNumber == 3 || _storyNumber == 4 || _storyNumber == 5) {
      _storyNumber = 0;
    }
    // print("$number  $_storyNumber");
  }
